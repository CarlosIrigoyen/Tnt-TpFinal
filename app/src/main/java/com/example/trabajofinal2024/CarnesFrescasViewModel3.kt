...
class CarnesFrescasViewModel3: ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Carne picada")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (165.1f)
    private val _carbohidratos = MutableLiveData<Float> (0.0f)
    private val _proteinas = MutableLiveData<Float> (20.2f)
    private val _grasasTotales = MutableLiveData<Float> (9.4f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (65.3f)
