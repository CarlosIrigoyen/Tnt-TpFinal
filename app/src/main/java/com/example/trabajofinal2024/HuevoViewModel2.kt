...
class HuevoViewModel2: ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Huevo de gallina entero frito")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (191.3f)
    private val _carbohidratos = MutableLiveData<Float> (0.8f)
    private val _proteinas = MutableLiveData<Float> (13.6f)
    private val _grasasTotales = MutableLiveData<Float> (14.8f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (401.0f)
