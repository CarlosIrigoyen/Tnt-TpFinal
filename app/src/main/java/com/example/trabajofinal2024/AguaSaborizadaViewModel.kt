...
class AguaSaborizadaViewModel: ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Aguas saborizadas clasicas")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (32.0f)
    private val _carbohidratos = MutableLiveData<Float> (8.0f)
