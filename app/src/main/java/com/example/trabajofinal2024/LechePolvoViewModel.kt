...
class LechePolvoViewModel: ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Leche en polvo entera")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (494.0f)
    private val _carbohidratos = MutableLiveData<Float> (38.1f)
    private val _proteinas = MutableLiveData<Float> (26.2f)
    private val _grasasTotales = MutableLiveData<Float> (26.4f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (80.5f)
