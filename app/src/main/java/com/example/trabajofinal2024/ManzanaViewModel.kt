...
class ManzanaViewModel: ViewModel() {
    private val _cantidad = MutableLiveData<String>()
    private val _numeroVeces = MutableLiveData<String>()
    private val _categoria = MutableLiveData<String>("Frutas")
    private val _alimento = MutableLiveData<String>("Manzana")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (58.2f)
    private val _carbohidratos = MutableLiveData<Float> (13.8f)
    private val _proteinas = MutableLiveData<Float> (0.3f)
    private val _grasasTotales = MutableLiveData<Float> (0.2f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (0.0f)
    private val _fibra = MutableLiveData<Float> (2.4f)
