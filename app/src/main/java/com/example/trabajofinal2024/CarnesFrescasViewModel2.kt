...
class CarnesFrescasViewModel2: ViewModel() {
    private val _cantidad = MutableLiveData<String>()
    private val _numeroVeces = MutableLiveData<String>()
    private val _categoria = MutableLiveData<String>("Carnes y huevos")
    private val _alimento = MutableLiveData<String>("Carne vacuna con cortes grasos")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (199.6f)
    private val _carbohidratos = MutableLiveData<Float> (0.0f)
    private val _proteinas = MutableLiveData<Float> (19.0f)
    private val _grasasTotales = MutableLiveData<Float> (13.8f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (68.3f)
