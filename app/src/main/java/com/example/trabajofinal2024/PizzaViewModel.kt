...
class PizzaViewModel : ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Pizza")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (251.9f)
    private val _carbohidratos = MutableLiveData<Float> (26.5f)
    private val _proteinas = MutableLiveData<Float> (13.6f)
    private val _grasasTotales = MutableLiveData<Float> (10.2f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (17.0f)
    private val _fibra = MutableLiveData<Float> (2.3f)
