...
class HuevoViewModel: ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Huevo de gallina entero crudo")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (153.8f)
    private val _carbohidratos = MutableLiveData<Float> (0.2f)
    private val _proteinas = MutableLiveData<Float> (12.7f)
    private val _grasasTotales = MutableLiveData<Float> (11.4f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (449.0f)
