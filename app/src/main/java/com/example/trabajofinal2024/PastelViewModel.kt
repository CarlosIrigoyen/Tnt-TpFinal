...
class PastelViewModel : ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Pastel de papas")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (143.3f)
    private val _carbohidratos = MutableLiveData<Float> (7.7f)
    private val _proteinas = MutableLiveData<Float> (8.3f)
    private val _grasasTotales = MutableLiveData<Float> (8.8f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (68.5f)
    private val _fibra = MutableLiveData<Float> (1.0f)
