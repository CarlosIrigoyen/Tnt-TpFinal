...
class QuesoViewModel2 : ViewModel() {
    private val _cantidad = MutableLiveData<String>()
    private val _numeroVeces = MutableLiveData<String>()
    private val _categoria = MutableLiveData<String>("Grasas animales")
    private val _alimento = MutableLiveData<String>("Quesos de pasta semidura")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (328.2f)
    private val _carbohidratos = MutableLiveData<Float> (0.1f)
    private val _proteinas = MutableLiveData<Float> (25.3f)
    private val _grasasTotales = MutableLiveData<Float> (25.2f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (72.1f)
