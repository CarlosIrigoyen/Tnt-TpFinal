...
class CervezaViewModel : ViewModel() {
    private val _cantidad = MutableLiveData<String>()
    private val _numeroVeces = MutableLiveData<String>()
    private val _categoria = MutableLiveData<String>("Bebidas alcoholicas")
    private val _alimento = MutableLiveData<String>("Cerveza")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (35.5f)
    private val _carbohidratos = MutableLiveData<Float> (1.6f)
    private val _proteinas = MutableLiveData<Float> (0.3f)
    private val _grasasTotales = MutableLiveData<Float> (0.1f)
    private val _alcohol = MutableLiveData<Float> (3.9f)
    private val _colesterol = MutableLiveData<Float> (0.0f)
