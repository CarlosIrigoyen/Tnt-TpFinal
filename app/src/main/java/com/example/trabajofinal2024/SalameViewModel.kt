...
class SalameViewModel: ViewModel() {
        ...
        private val _alimento = MutableLiveData<String>("Salame")
        private val _gramos = MutableLiveData<Float>(100.0f)
        private val _kilocal = MutableLiveData<Float>(377.5f)
        private val _carbohidratos = MutableLiveData<Float>(0.3f)
        private val _proteinas = MutableLiveData<Float>(19.5f)
        private val _grasasTotales = MutableLiveData<Float>(33.1f)
        private val _alcohol = MutableLiveData<Float>(0.0f)
        private val _colesterol = MutableLiveData<Float>(78.0f)
