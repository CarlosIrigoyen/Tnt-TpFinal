...
class DuraznoViewModel: ViewModel() {
    ...
    private val _kilocal = MutableLiveData<Float> (46.5f)
    private val _carbohidratos = MutableLiveData<Float> (10.1f)
    private val _proteinas = MutableLiveData<Float> (0.9f)
    ...
    private val _fibra = MutableLiveData<Float> (1.5f)
