...
class EmpanadaViewModel : ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Empanadas de carne fritas")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (297.5f)
    private val _carbohidratos = MutableLiveData<Float> (14.8f)
    private val _proteinas = MutableLiveData<Float> (10.1f)
    private val _grasasTotales = MutableLiveData<Float> (22.0f)
