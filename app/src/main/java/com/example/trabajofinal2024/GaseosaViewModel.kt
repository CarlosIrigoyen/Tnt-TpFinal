...
class GaseosaViewModel: ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Gaseosas clasicas")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (43.0f)
    private val _carbohidratos = MutableLiveData<Float> (10.7f)
