...
class LicorViewModel : ViewModel() {
    ...
    private val _kilocal = MutableLiveData<Float> (370.4f)
    private val _carbohidratos = MutableLiveData<Float> (46.8f)
    private val _proteinas = MutableLiveData<Float> (0.1f)
    private val _grasasTotales = MutableLiveData<Float> (0.3f)
    private val _alcohol = MutableLiveData<Float> (25.8f)
