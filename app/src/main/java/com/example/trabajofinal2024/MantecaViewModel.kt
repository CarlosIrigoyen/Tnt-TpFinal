...
class MantecaViewModel : ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Manteca")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (745.4f)
    private val _carbohidratos = MutableLiveData<Float> (0.0f)
    private val _proteinas = MutableLiveData<Float> (0.3f)
    private val _grasasTotales = MutableLiveData<Float> (82.7f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (223.0f)
