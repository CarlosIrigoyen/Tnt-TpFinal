...
class BebidaDeportivaViewModel: ViewModel() {
    private val _cantidad = MutableLiveData<String>()
    private val _numeroVeces = MutableLiveData<String>()
    private val _categoria = MutableLiveData<String>("Bebidas e infusiones azucaradas")
    private val _alimento = MutableLiveData<String>("Bebidas deportivas y energizantes")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (24.0f)
    private val _carbohidratos = MutableLiveData<Float> (6.0f)
    private val _proteinas = MutableLiveData<Float> (0.0f)
    private val _grasasTotales = MutableLiveData<Float> (0.0f)
