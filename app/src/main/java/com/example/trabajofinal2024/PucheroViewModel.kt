...
class PucheroViewModel : ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Puchero")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (100.1f)
    private val _carbohidratos = MutableLiveData<Float> (12.4f)
    private val _proteinas = MutableLiveData<Float> (5.5f)
    private val _grasasTotales = MutableLiveData<Float> (3.2f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (14.4f)
    private val _fibra = MutableLiveData<Float> (4.0f)
