...
class MortadelaViewModel: ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Mortadela")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (265.2f)
    private val _carbohidratos = MutableLiveData<Float> (1.6f)
    private val _proteinas = MutableLiveData<Float> (13.0f)
    private val _grasasTotales = MutableLiveData<Float> (23.0f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (71.0f)
