...
class BananaViewModel: ViewModel() {
    ...
    private val _kilocal = MutableLiveData<Float> (98.7f)
    private val _carbohidratos = MutableLiveData<Float> (22.8f)
    private val _proteinas = MutableLiveData<Float> (1.1f)
    ...
    private val _fibra = MutableLiveData<Float> (2.6f)
