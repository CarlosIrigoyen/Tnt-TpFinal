...
class PapasViewModel : ViewModel() {
    ...
    private val _kilocal = MutableLiveData<Float> (162.0f)
    private val _carbohidratos = MutableLiveData<Float> (17.5f)
    private val _proteinas = MutableLiveData<Float> (2.1f)
    private val _grasasTotales = MutableLiveData<Float> (9.3f)
