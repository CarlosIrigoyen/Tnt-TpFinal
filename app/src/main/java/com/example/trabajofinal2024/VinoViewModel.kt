...
class VinoViewModel : ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Vino")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (86.6f)
    private val _carbohidratos = MutableLiveData<Float> (3.2f)
    private val _proteinas = MutableLiveData<Float> (0.2f)
    private val _grasasTotales = MutableLiveData<Float> (0.0f)
    private val _alcohol = MutableLiveData<Float> (10.5f)
