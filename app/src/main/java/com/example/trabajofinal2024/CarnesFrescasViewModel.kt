...
class CarnesFrescasViewModel: ViewModel() {
    ...
    private val _alimento = MutableLiveData<String>("Carne vacuna magra")
    private  val _gramos = MutableLiveData<Float> (100.0f)
    private val _kilocal = MutableLiveData<Float> (130.6f)
    private val _carbohidratos = MutableLiveData<Float> (0.0f)
    private val _proteinas = MutableLiveData<Float> (21.4f)
    private val _grasasTotales = MutableLiveData<Float> (5.0f)
    private val _alcohol = MutableLiveData<Float> (0.0f)
    private val _colesterol = MutableLiveData<Float> (62.3f)
